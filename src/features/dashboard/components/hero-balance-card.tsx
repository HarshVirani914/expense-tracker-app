  ...
  ({
    ...
    return (
      <div className="relative overflow-hidden rounded-2xl border border-border grain-overlay">
        ...
        <div className="absolute inset-0 bg-card dark:bg-[#131316]" />

        {/* Ambient glow — cobalt top-right, teal bottom-left */}
        <div className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-[#494FDF]/10 blur-3xl dark:bg-[#494FDF]/25" />
        <div className="absolute -bottom-16 -left-16 h-48 w-48 rounded-full bg-[#00A87E]/8 blur-3xl dark:bg-[#00A87E]/12" />
        ...
        <div className="relative px-5 pt-5 pb-4 md:px-7 md:pt-7 md:pb-5">
          {/* Greeting */}
          {userName && (
            <p className="mb-3 text-[11px] font-medium uppercase tracking-[0.2em] text-muted-foreground dark:text-white/45">
              Good day, {userName}
            </p>
          )}

          {/* Label */}
          <p className="mb-1 text-xs font-medium uppercase tracking-widest text-muted-foreground dark:text-white/50">
            Total balance
          </p>
          ...
          {totalFlow > 0 && (
            <div className="mt-4 space-y-2">
              <div className="flex overflow-hidden rounded-full h-1 bg-foreground/10">
                <div
                  className="h-full rounded-l-full bg-emerald-500/80 transition-all duration-700 dark:bg-emerald-400/70"
